...
public class SelectiveColorYellowsManipulatorForGreensTask extends Task<int[]> {
   ...
   private int currentBlueValue ;
	...
	public SelectiveColorYellowsManipulatorForGreensTask( Canvas canvas , int currentBlueValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
