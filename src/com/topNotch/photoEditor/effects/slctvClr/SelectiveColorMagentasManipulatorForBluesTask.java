...
public class SelectiveColorMagentasManipulatorForBluesTask extends Task<int[]> {
   ...
   private int currentGreenValue ;
	...
	public SelectiveColorMagentasManipulatorForBluesTask( Canvas canvas , int currentGreenValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
