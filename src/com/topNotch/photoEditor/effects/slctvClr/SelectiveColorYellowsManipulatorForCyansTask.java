...
public class SelectiveColorYellowsManipulatorForCyansTask extends Task<int[]> {
   ...
   private int currentBlueValue ;
	...
	public SelectiveColorYellowsManipulatorForCyansTask( Canvas canvas , int currentBlueValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
            , double[] actualBlueInFraction , double[] counterBlueInFraction , int[] differenceBetweenActualGreenAndActualRed 
					...
					if( currentBlueValue >= 0 ) {
						...
						if( actualBlue[i] > actualGreen[i] ) {
							...
							if( actualBlue[i] > 127 ) {
								...
								currentBlue = (differenceBetweenActualGreenAndActualRed[i]*actualBlueInFraction[i])*(currentBlueValue/(double)100) ;
								newBlue = (int)(actualBlue[i] - currentBlue) ;
							}
						}
						else {
	                        ...
	                        if( actualBlue[i] > 127 ) {
								...
								currentBlue = (differenceBetweenActualBlueAndActualRed[i]*counterBlueInFraction[i])*(currentBlueValue/(double)100) ;
								newBlue = (int)(actualBlue[i] - currentBlue) ;
							}
							else {
								
								currentBlue = (differenceBetweenActualBlueAndActualRed[i]*actualBlueInFraction[i])*(currentBlueValue/(double)100) ;
								newBlue = (int)(actualBlue[i] - currentBlue) ;
							}
						}
					}
