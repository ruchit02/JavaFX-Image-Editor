...
public class SelectiveColorYellowsManipulatorForRedsTask extends Task<int[]> {
   ...
   private int currentBlueValue ;
	...
	public SelectiveColorYellowsManipulatorForRedsTask( Canvas canvas , int currentBlueValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
