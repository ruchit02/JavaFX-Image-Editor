...
public class SelectiveColorCyansManipulatorForRedsTask extends Task<int[]> {
   ...
   private int currentRedValue ;
	...
	public SelectiveColorCyansManipulatorForRedsTask( Canvas canvas , int currentRedValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
