...
public class IterateMagentaGreenHighlightsTask extends Task<int[]>{
	...
	public IterateMagentaGreenHighlightsTask( Canvas canvas , int currentRedValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
