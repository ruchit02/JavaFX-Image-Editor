...
public class IterateCyanRedShadowsTask2 extends Task<int[]>{
	...
	public IterateCyanRedShadowsTask2( Canvas canvas , int currentRedValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
