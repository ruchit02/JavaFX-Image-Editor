...
public class IterateMagentaGreenMidtonesTask extends Task<int[]>{
	...
	public IterateMagentaGreenMidtonesTask( Canvas canvas , int currentGreenValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
