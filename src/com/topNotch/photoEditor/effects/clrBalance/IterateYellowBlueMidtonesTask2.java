...
public class IterateYellowBlueMidtonesTask2 extends Task<int[]>{
	...
	public IterateYellowBlueMidtonesTask2( Canvas canvas , int currentBlueValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
