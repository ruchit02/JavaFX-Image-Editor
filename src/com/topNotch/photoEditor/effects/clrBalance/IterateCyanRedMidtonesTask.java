...
public class IterateCyanRedMidtonesTask extends Task<int[]>{
	...
	public IterateCyanRedMidtonesTask( Canvas canvas , int currentRedValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
