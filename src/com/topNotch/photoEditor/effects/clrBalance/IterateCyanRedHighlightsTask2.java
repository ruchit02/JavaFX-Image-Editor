...
public class IterateCyanRedHighlightsTask2 extends Task<int[]>{
	...
	public IterateCyanRedHighlightsTask2( Canvas canvas , int currentRedValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
