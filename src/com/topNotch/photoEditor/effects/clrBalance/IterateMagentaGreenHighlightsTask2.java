...
public class IterateMagentaGreenHighlightsTask2 extends Task<int[]>{
	...
	public IterateMagentaGreenHighlightsTask2( Canvas canvas , int currentRedValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
