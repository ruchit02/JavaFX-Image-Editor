...
public class IterateYellowBlueShadowsTask2 extends Task<int[]>{
	...
	public IterateYellowBlueShadowsTask2( Canvas canvas , int currentRedValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
