...
public class IterateYellowBlueShadowsTask extends Task<int[]>{
	...
	public IterateYellowBlueShadowsTask( Canvas canvas , int currentRedValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue 
