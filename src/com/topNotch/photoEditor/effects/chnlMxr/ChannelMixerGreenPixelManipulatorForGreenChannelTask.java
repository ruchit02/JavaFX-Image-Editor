...
public class ChannelMixerGreenPixelManipulatorForGreenChannelTask extends Task<int[]> {
   ...
   private int currentGreenValue ;
	...
	public ChannelMixerGreenPixelManipulatorForGreenChannelTask( Canvas canvas , int currentGreenValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue ) {
	...
	protected int[] call() {
		...
		for( int y = 0 ; y < height ; y++ ) {
			for( int x = 0 ; x < width ; x++ ) {
				...
				newGreen = (int)((currentGreenValue/(double)100)*actualGreen[i]) ;
