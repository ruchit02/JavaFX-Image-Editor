...
public class ChannelMixerBluePixelManipulatorForBlueChannelTask extends Task<int[]> {
   ...
   private int currentBlueValue ;
	...
	public ChannelMixerBluePixelManipulatorForBlueChannelTask( Canvas canvas , int currentBlueValue ,  int[] actualRed , int[] actualGreen , int[] actualBlue ) {
	...
	protected int[] call() {
		...
		for( int y = 0 ; y < height ; y++ ) {
			for( int x = 0 ; x < width ; x++ ) {
				...
				newBlue = (int)((currentBlueValue/(double)100)*actualBlue[i]) ;
